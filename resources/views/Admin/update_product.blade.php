        ...
        <div class="page-content w-100">
            <div class="page-header">
                <div class="container-fluid">
                    <h2 class="h5 no-margin-bottom">Update Products</h2>
                </div>
            </div>
                                ...
                                <form action="{{url('edit_product',$product->id)}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="product_code" value="{{$product->product_code}}" id="product_code" placeholder="e.g., SKU-12345">
                                        </div>
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <textarea class="form-control" name="description" id="description" rows="4" placeholder="Provide a detailed description of the product..." required>{{$product->description}}</textarea>
                                        </div>

                                        {{-- Product Image --}}

                                        <div class="col-6 mb-3">
                                            <label for="image" class="form-label d-block heading">Current Image </label>
                                            <img src="{{asset($product->image)}}" alt="current image" class="img-fluid mb-2" style="max-width: 150px; max-height: 150px;">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number" step="0.01" class="form-control" name="store_price" id="store_price" value="{{$product->store_price}}" placeholder=" e.g., $99.99" required>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number" step="0.01" class="form-control" name="original_price" id="original_price" value="{{$product->original_price}}" placeholder="e.g., $79.99">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select" name="category" id="category" required>
                                                <option value="" class="text-muted" disabled hidden>Select Category</option>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" value="{{$product->brand}}" name="brand" id="brand" placeholder="e.g., Nike, Samsung">
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="size" id="size" value="{{$product->size}}" placeholder="e.g., M, 10, One Size">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="color" class="form-label heading">Color</label>
                                            <input type="text" class="form-control" name="color" id="color" value="{{$product->color}}" placeholder="e.g., Red, Blue, Black">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="slug" id="slug" value="{{$product->slug}}" placeholder="auto-generated if empty">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select" name="trending" id="trending">
                                                <option value="yes" {{ $product->trending == 1 ? 'selected' : '' }}>Yes</option>
                                                <option value="no" {{ $product->trending == 0 ? 'selected' : '' }}>No</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select" name="featured" id="featured">
                                                <option value="yes" {{ $product->featured == 1 ? 'selected' : '' }}>Yes</option>
                                                <option value="no" {{ $product->featured == 0 ? 'selected' : '' }}>No</option>
                                            </select>
                                        </div>
